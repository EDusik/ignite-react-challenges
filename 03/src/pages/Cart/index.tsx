        ...
        <tbody>
          {cartFormatted.map(product => (
            <tr data-testid="product" key={String(product.id)}>
              ...
              <td>
                <div>
                  <button disabled={product.amount <= 1} type="button" data-testid="decrement-product" onClick={() => handleProductDecrement(product)}>
                    <MdRemoveCircleOutline size={20} />
                  </button>
                  <input type="number" data-testid="product-amount" readOnly value={product.amount} />
              ...
              <td>
                <button
                  type="button" data-testid="remove-product" onClick={() => handleRemoveProduct(product.id)}>
                  <MdDelete size={20} />
                </button>
              </td>
            </tr>
